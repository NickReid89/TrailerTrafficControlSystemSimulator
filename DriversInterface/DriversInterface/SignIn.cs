...
namespace DriversInterface
{
    public partial class SignIn : Form
    {
        ...
        private void btnSignIn_Click(object sender, EventArgs e)
        {
            ...
            OdbcCommand cmd = new OdbcCommand("SELECT EMPLOYEEPASSWORD FROM EMPLOYEE WHERE LASTNAME = '" + txtUserName.Text + "'AND EMPLOYEETYPE = 'Driver';", Conn);
            Conn.Open();
            ...
            else
            {
                ...
                var frm = new frmDriverInterface(Emp);
                frm.ShowDialog();
                //this.Visible = false
            }
