...
{
    public partial class PlaceTrailerInLot : Form
    {
        public PlaceTrailerInLot(string TrNo)
        {
            InitializeComponent();
            LotStatus();
            lblTrNo.Text = TrNo;
        ...
        private void btnAcceptTrailer_Click(object sender, EventArgs e)
        {
